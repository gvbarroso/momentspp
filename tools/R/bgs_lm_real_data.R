...
# tables for storing Pearson correlations (rows are bin sizes)
...
summary(m_1kb)
r2_raw$r2_typeI[1] <- summary(m_1kb)$r.squared
...
summary(m_10kb)
r2_raw$r2_typeI[2] <- summary(m_10kb)$r.squared
...
summary(m_100kb)
r2_raw$r2_typeI[3] <- summary(m_100kb)$r.squared
...
summary(m_1Mb)
r2_raw$r2_typeI[4] <- summary(m_1Mb)$r.squared
...
fwrite(r2_raw, paste(prefix, "_r2_raw_tbl.csv.gz", sep=""))
