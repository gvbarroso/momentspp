...
# Uses data generated by setup_models.Rmd to simulate chromosomal landscapes of
# mutation, recombination and selection, for which B-values and expectations of
# pi0 and pi can be computed using bgs_pi.R
...
while(any(alpha < -20)) { # constraint on moments++
