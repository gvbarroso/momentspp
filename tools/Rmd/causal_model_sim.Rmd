...
library(ggforce)   # optional for geom_bezier (smoother arcs)
library(lavaan)
library(dagitty)
library(ggdag)
library(magrittr)
...
```{r, build-chr-models, eval=F, include=T, message=F, warning=F}
...
```{r, build-chr-maps, eval=F, include=T, message=F, warning=F}
...
```{r dags-viz, eval=F, include=T, message=F, warning=F}
