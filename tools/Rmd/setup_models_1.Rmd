...
uL <-1e-8
r <- round(sort(c(seq_log(from=1e-8, to=1e-3, length.out=10),
                  seq(from=1e-4, to=1e-2, length.out=10), 0)), digits=12)
s <- round(-sort(c(seq_log(from=1e-5, to=1e-4, length.out=10), 
                   seq_log(from=7.5e-5, to=1e-3, length.out=10), 0)), digits=12)
