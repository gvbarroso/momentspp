...
for(i in 1:num_models) {
  ...
  save_plot(paste("model_", i, "_sim_r2.png", sep=""), 
...
exons_100kb <- as.data.frame(matrix(nrow=num_models*num_reps, ncol=1e+3))
...
for(m in 1:num_models) {
  ...
  for(rep in 1:num_reps) {
    ...
    exons_100kb[idx,] <- maps_100kb$exonic_sites
  }
}
close(pb)

names(muts_100kb) <- paste("bin", 1:ncol(muts_100kb), sep="_")
muts_100kb$model <- sort(rep(1:865, 10))
