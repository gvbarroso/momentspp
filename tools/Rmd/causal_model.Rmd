...
for(m in 1:num_models) {
  ...
  for(rep in 1:num_reps) {
    ...
    row <- which(names(cors_10kb) == "B")
    B_vs_del_sites_10kb[m, rep] <- cors_10kb[row, "del_sites"]
    B_vs_del_sites_100kb[m, rep] <- cors_100kb[row, "del_sites"]
    B_vs_del_sites_1Mb[m, rep] <- cors_1Mb[row, "del_sites"]
