...
p <- ggplot(data=filter(chr_r2_ext,
                        gfi > 0.95), 
             aes(x=chrom, 
                 y=avg_pi, 
                 color=mut_map,
...
q <- ggplot(data=filter(chr_r2_ext,
                        gfi > 0.95), 
             aes(x=chrom, 
                 y=B, 
                 color=mut_map,
...
r <- ggplot(data=filter(chr_r2_ext,
                        gfi > 0.95), 
             aes(x=chrom, 
                 y=avg_mut, 
                 color=mut_map,
...
p <- ggplot(data=filter(chr_params,
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Path Coefficients to Pi (DAG 0, GFI > 0.95, pval_est < 0.05)",
...
q <- ggplot(data=filter(chr_params,
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Path Coefficients to Pi (DAG 1, GFI > 0.95, pval_est < 0.05)",
           x="Chromosome", y="Direct Std. PC to Diversity") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
...
p <- ggplot(data=filter(chr_params,
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Path Coefficients to B (DAG 0, GFI > 0.95, pval_est < 0.05)",
...
q <- ggplot(data=filter(chr_params,
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Path Coefficients to B (DAG 1, GFI > 0.95, pval_est < 0.05)",
           x="Chromosome", y="Direct Std. PC to B") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
...
p <- ggplot(data=gw_fitmeasures_latent, 
      ...
      scale_y_continuous(breaks=pretty_breaks()) +
      scale_x_continuous(breaks=c(1e+4, 1e+5, 1e+6)) +
      scale_color_manual(values=c("purple3", "seagreen4"), 
                         name="DAG") +
...
# NOTE there are no fit measures available for DAGs 0-1
chr_r2_gls <- rbind.data.frame(chr_r2_10kb_gls,
                               chr_r2_100kb_gls,
                               chr_r2_1Mb_gls)

p <- ggplot(data=chr_r2_gls, 
             aes(x=chrom, 
                 y=avg_pi, 
                 color=as.factor(DAG))) +
      geom_point(size=2) + 
