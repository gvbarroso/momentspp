...
p <- ggplot(data=gw_fitmeasures, 
             aes(x=mut_map, 
                 ...
                 shape=as.factor(DAG))) +
      geom_point(size=2) +
      facet_grid(constrained_model~scale, labeller=label_both) + theme_bw() + 
      scale_y_continuous(breaks=pretty_breaks()) +
...
q <- ggplot(data=chr_r2, 
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/chr_r2_B_DAGs0-1_A.png", p, 
          base_height=10, base_width=20)
...
r <- ggplot(data=gw_r2_mut, 
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/gw_r2_mut_DAGs2-3.png", q, 
          base_height=10, base_width=20)
...
q <- ggplot(data=filter(chr_r2_ext,
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/chr_r2_B_DAGs2-3_B.png", p, 
          base_height=10, base_width=20)
...
r <- ggplot(data=filter(chr_r2_ext,
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/chr_r2_mut_DAGs2-3_B.png", p, 
          base_height=10, base_width=20)
```
...
p <- ggplot(data=filter(gw_params, lhs=="avg_pi"), 
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/gw_PCs_pi.png", p, 
          base_height=10, base_width=16)
...
q <- ggplot(data=filter(gw_params, lhs=="B"), 
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/gw_PCs_B.png", p, 
          base_height=10, base_width=16)
