...
spacing = 1000 # predict Bs every 1 kb
...
pi0_syn = 2 * Ne * u_avg * syn_fac # synonymous
...
maps_1kb.insert(len(maps_1kb.columns), "pi_neu_sim", pi_1kb)
...
pc_nonmut_rec_pi <- filter(pc_nonmut_rec, lhs=="pi_neu_sim" | 
                                          lhs=="sim_pi" |
                                          lhs=="mu_B_pi")

pc_mut_rec_pi <- filter(pc_mut_rec, lhs=="pi_neu_sim" |
                                    lhs=="sim_pi" | 
                                    lhs=="mu_B_pi")
...
m_pc_sem_rec_pi$pi_source <- ifelse(m_pc_sem_rec_pi$DAG == 2, "neu", "sim")
...
p2 <- ggplot(data=filter(m_pc_sem_p_mutrec, 
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("SEM/pc_mu_pi_neu_sim_DAG2.png", p2, base_height=10, base_width=16)
...
p3 <- ggplot(data=filter(m_pc_sem_p_nonmutrec,
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("SEM/pc_mu_B_pi_neu_sim_DAG1.png", p3, base_height=10, base_width=16)
...
q1 <- ggplot(data=filter(m_pc_sem_p_nonmutrec,
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("SEM/pc_B_pi_neu_sim_DAG1.png", q1, base_height=10, base_width=16)
...
q2 <- ggplot(data=filter(m_pc_sem_p_mutrec,
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("SEM/pc_mu_pi_neu_sim_DAG1.png", q2, base_height=10, base_width=16)
...
q3 <- ggplot(data=filter(m_pc_sem_p_nonmutrec, 
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("SEM/pc_mu_B_pi_neu_sim_DAG4.png", q3, base_height=10, base_width=16)
...
# NOTE: there are some strong outliers in pred. with build_B_table.py
human_maps_1kb <- filter(human_maps_1kb, exp_pi < 3e-3) 
TODO implement the alternative filtering/binning scheme where 1kb windows w/ less than 75% sites are filtered out first, then averages are computed
...
human_filtered_10kb$sim_pi <- pi_sim / S
fwrite(human_filtered_10kb, "real_data_maps/human_maps_10kb.csv.gz")
...
S = 100 # diploid sample size
pi_sim <- numeric(length=nrow(human_filtered_100kb))
for(i in 1:S) { 
    pi_sim <- pi_sim + rbinom(size=1e+5, 
                              n=nrow(human_filtered_100kb),
                              prob=human_filtered_100kb$exp_pi) / 1e+5
}
     
human_filtered_100kb$sim_pi <- pi_sim / S
fwrite(human_filtered_100kb, "real_data_maps/human_maps_100kb.csv.gz")
...
S = 100 # diploid sample size
pi_sim <- numeric(length=nrow(human_filtered_1Mb))
for(i in 1:S) { 
    pi_sim <- pi_sim + rbinom(size=1e+6, 
                              n=nrow(human_filtered_1Mb),
                              prob=human_filtered_1Mb$exp_pi) / 1e+6
}
     
human_filtered_1Mb$sim_pi <- pi_sim / S
fwrite(human_filtered_1Mb, "real_data_maps/human_maps_1Mb.csv.gz")
...
```{r SEM-human-maps, include=F, message=F, warning=F}

# df's of dimenons num chrom by num scales
pval_sem3 <- as.data.frame(matrix(nrow=22, ncol=3))
pval_sem4 <- as.data.frame(matrix(nrow=22, ncol=3))
pval_sem5 <- as.data.frame(matrix(nrow=22, ncol=3))
pval_sem6 <- as.data.frame(matrix(nrow=22, ncol=3))

pb <- txtProgressBar(min=0, max=22, style=3)
for(c in 1:22) { # for each autosome
  
  setTxtProgressBar(pb, c)
  
  maps_10kb <- filter(human_filtered_10kb, chr==c) %>% as.data.table()
  maps_100kb <- filter(human_filtered_100kb, chr==c) %>% as.data.table()
  maps_1Mb <- filter(human_filtered_1Mb, chr==c) %>% as.data.table()
  ...
  fwrite(mvn_tbl, paste("real_data_maps/mvn_tests_chr", c, ".csv", sep=""))
  
  std_10kb <- as.data.frame(apply(apply(dplyr::select(maps_10kb,
    c(avg_mut, avg_rec, B, del_sites, sim_pi, avg_pi)), 2, log1p),
    2, function(x) (x-mean(x)) / sd(x)))
  
  std_100kb <- as.data.frame(apply(apply(dplyr::select(maps_100kb,
    c(avg_mut, avg_rec, B, del_sites, sim_pi, avg_pi)), 2, log1p),
    2, function(x) (x-mean(x)) / sd(x)))
  ...
  # Q-Q plots, also keeping only endogenous variables (Bolen, 1989 apud Shipley)
  svg(paste("real_data_maps/qq_chr", c, "_10kb.svg", sep=""), width=9, height=7)
  heplots::cqplot(dplyr::select(std_10kb, c(avg_mut, B, sim_pi)))
  dev.off()
  
  svg(paste("real_data_maps/qq_chr", c, "_100kb.svg", sep=""), width=9, height=7)
  heplots::cqplot(dplyr::select(std_100kb, c(avg_mut,  B, sim_pi)))
  dev.off()
  
  svg(paste("real_data_maps/qq_chr", c, "_1Mb.svg", sep=""), width=9, height=7)
  heplots::cqplot(dplyr::select(std_1Mb, c(avg_mut, B, sim_pi)))
  dev.off()
  
  # pairwise scatter plots
  svg(paste("real_data_maps/scatter_chr", c, "_10kb.svg", sep=""), width=9, height=7)
  pairs(std_10kb)
  dev.off()
  
  svg(paste("real_data_maps/scatter_chr", c, "_100kb.svg", sep=""), width=9, height=7)
  pairs(std_100kb)
  dev.off()
  
  svg(paste("real_data_maps/scatter_chr", c, "_1Mb.svg", sep=""), width=9, height=7)
  pairs(std_1Mb)
  dev.off()
  
  # DAG3
  sem3_10kb <- sem(DAG3, data=std_10kb, estimator="GLS", se="boot", test="boot")
  sem3_100kb <- sem(DAG3, data=std_100kb, estimator="GLS", se="boot", test="boot")
  sem3_1Mb <- sem(DAG3, data=std_1Mb, estimator="GLS", se="boot", test="boot")
  
  # error handling to bypass cases where lavaan fails to converge the optim
  # such cases can be identified as NA entries in the pval table
  tryCatch({
    pval_sem3[c, 1] <- fitMeasures(sem3_10kb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  
  tryCatch({
    pval_sem3[c, 2] <- fitMeasures(sem3_100kb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  
  tryCatch({
    pval_sem3[c, 3] <- fitMeasures(sem3_1Mb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  ...
  sem3_r2 <- rbind.data.frame(inspect(sem3_10kb, "rsquare"),
                              ...
                              inspect(sem3_1Mb, "rsquare"))
  names(sem3_r2) <- c("pi_sim", "B")
  fwrite(sem3_r2, paste("real_data_maps/sem_DAG3_r2_chr", c, ".csv", sep=""))
  
  fwrite(parameterestimates(sem3_10kb, ci=T), 
         paste("real_data_maps/lavaan_DAG3_chr", c, "_10kb.csv", sep=""))
  
  fwrite(parameterestimates(sem3_100kb, ci=T), 
         paste("real_data_maps/lavaan_DAG3_chr", c, "_100kb.csv", sep=""))
  
  fwrite(parameterestimates(sem3_1Mb, ci=T), 
         paste("real_data_maps/lavaan_DAG3_chr", c, "_1Mb.csv", sep=""))
  
  # DAG4
  sem4_10kb <- sem(DAG4, data=std_10kb, estimator="GLS", se="boot", test="boot")
  sem4_100kb <- sem(DAG4, data=std_100kb, estimator="GLS", se="boot", test="boot")
  sem4_1Mb <- sem(DAG4, data=std_1Mb, estimator="GLS", se="boot", test="boot")
  
  # error handling to bypass cases where lavaan fails to converge the optim
  # such cases can be identified as NA entries in the pval table
  tryCatch({
    pval_sem4[c, 1] <- fitMeasures(sem4_10kb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  
  tryCatch({
    pval_sem4[c, 2] <- fitMeasures(sem4_100kb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  
  tryCatch({
    pval_sem4[c, 3] <- fitMeasures(sem4_1Mb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  ...
  sem4_r2 <- rbind.data.frame(inspect(sem4_10kb, "rsquare"),
                              ...
                              inspect(sem4_1Mb, "rsquare"))
  names(sem4_r2) <- c("pi_sim", "B", "avg_mut")
  fwrite(sem4_r2, paste("real_data_maps/sem_DAG4_r2_chr", c, ".csv", sep=""))
  
  fwrite(parameterestimates(sem4_10kb, ci=T), 
         paste("real_data_maps/lavaan_DAG4_chr", c, "_10kb.csv", sep=""))
  
  fwrite(parameterestimates(sem4_100kb, ci=T), 
         paste("real_data_maps/lavaan_DAG4_chr", c, "_100kb.csv", sep=""))
  
  fwrite(parameterestimates(sem4_1Mb, ci=T), 
         paste("real_data_maps/lavaan_DAG4_chr", c, "_1Mb.csv", sep=""))
  
  # DAG5
  sem5_10kb <- sem(DAG5, data=std_10kb, estimator="GLS", se="boot", test="boot")
  sem5_100kb <- sem(DAG5, data=std_100kb, estimator="GLS", se="boot", test="boot")
  sem5_1Mb <- sem(DAG5, data=std_1Mb, estimator="GLS", se="boot", test="boot")
  
  # error handling to bypass cases where lavaan fails to converge the optim
  # such cases can be identified as NA entries in the pval table
  tryCatch({
    pval_sem5[c, 1] <- fitMeasures(sem5_10kb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  
  tryCatch({
    pval_sem5[c, 2] <- fitMeasures(sem5_100kb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  
  tryCatch({
    pval_sem5[c, 3] <- fitMeasures(sem5_1Mb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  
  sem5_r2 <- rbind.data.frame(inspect(sem5_10kb, "rsquare"),
                              inspect(sem5_100kb, "rsquare"),
                              inspect(sem5_1Mb, "rsquare"))
  names(sem5_r2) <- c("pi_sim", "B")
  fwrite(sem5_r2, paste("real_data_maps/sem_DAG5_r2_chr", c, ".csv", sep=""))
  
  fwrite(parameterestimates(sem5_10kb, ci=T), 
         paste("real_data_maps/lavaan_DAG5_chr", c, "_10kb.csv", sep=""))
  
  fwrite(parameterestimates(sem5_100kb, ci=T), 
         paste("real_data_maps/lavaan_DAG5_chr", c, "_100kb.csv", sep=""))
  
  fwrite(parameterestimates(sem5_1Mb, ci=T), 
         paste("real_data_maps/lavaan_DAG5_chr", c, "_1Mb.csv", sep=""))
  
  # DAG6
  sem6_10kb <- sem(DAG6, data=std_10kb, estimator="GLS", se="boot", test="boot")
  sem6_100kb <- sem(DAG6, data=std_100kb, estimator="GLS", se="boot", test="boot")
  sem6_1Mb <- sem(DAG6, data=std_1Mb, estimator="GLS", se="boot", test="boot")
  
  # error handling to bypass cases where lavaan fails to converge the optim
  # such cases can be identified as NA entries in the pval table
  tryCatch({
    pval_sem6[c, 1] <- fitMeasures(sem6_10kb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  
  tryCatch({
    pval_sem6[c, 2] <- fitMeasures(sem6_100kb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  
  tryCatch({
    pval_sem6[c, 3] <- fitMeasures(sem6_1Mb)[5]
  }, error=function(e){cat("WARNING :", conditionMessage(e), "\n")})
  
  sem6_r2 <- rbind.data.frame(inspect(sem6_10kb, "rsquare"),
                              inspect(sem6_100kb, "rsquare"),
                              inspect(sem6_1Mb, "rsquare"))
  names(sem6_r2) <- c("pi_sim", "B", "avg_mut")
  fwrite(sem6_r2, paste("real_data_maps/sem_DAG6_r2_chr", c, ".csv", sep=""))
  
  fwrite(parameterestimates(sem6_10kb, ci=T), 
         paste("real_data_maps/lavaan_DAG6_chr", c, "_10kb.csv", sep=""))
  
  fwrite(parameterestimates(sem6_100kb, ci=T), 
         paste("real_data_maps/lavaan_DAG6_chr", c, "_100kb.csv", sep=""))
  
  fwrite(parameterestimates(sem6_1Mb, ci=T), 
         paste("real_data_maps/lavaan_DAG6_chr", c, "_1Mb.csv", sep=""))
}
close(pb)
