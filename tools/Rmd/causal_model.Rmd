...
for(c in 1:22) { # for each autosome
  ...
  # DAG5
  sem5_10kb <- sem(DAG5, data=std_10kb, estimator="GLS")
  sem5_100kb <- sem(DAG5, data=std_100kb, estimator="GLS")
  sem5_1Mb <- sem(DAG5, data=std_1Mb, estimator="GLS")
  ...
  # DAG6
  sem6_10kb <- sem(DAG6, data=std_10kb, estimator="GLS")
  sem6_100kb <- sem(DAG6, data=std_100kb, estimator="GLS")
  sem6_1Mb <- sem(DAG6, data=std_1Mb, estimator="GLS")
