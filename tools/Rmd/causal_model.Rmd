...
## NOTE: this model cannot be tested (empty basis set)
D0 <- DAG(
  pi_sim_tot~B,
  pi_sim_tot~avg_mut, 
  B~avg_mut
...
basis_set <- basiSet(D1)
weights <- rep(1, length=length(basis_set))
    
num_chrom <- 22
num_reps <- 1e+4 # sampling the dataframe for reducing autocorrelation

dsep_c_1Mb <- as.data.frame(matrix(ncol=num_chrom, nrow=num_reps))
names(dsep_c_1Mb) <- paste("chr_", 1:num_chrom, sep="")

pb <- txtProgressBar(min=0, max=num_chrom, style=3)  
for(c in 1:num_chrom) {
  setTxtProgressBar(pb, c)
  df <- filter(human_maps_1Mb, chr==c)
  for(rep in 1:num_reps) {

    samp <- sample_n(df, nrow(df))
    pvals_1Mb <- rep(NA, length(basis_set))
    ...
    for(i in 1:length(basis_set)) {
      ...
      stopifnot(dSep(D1, var1, var2, cond))
      
      # pcor.test requires matrix inversions which can potentially cause errors
      # we let these cases remain NA in the pval vectors
      if(length(basis_set[[i]]) > 2) {
          pvals_1Mb[i] <- ppcor::pcor.test(samp[, ..var1], 
                                           samp[, ..var2], 
                                           samp[, ..cond],
                                           method="spearman")$p.value
      } else {
        pvals_1Mb[i] <- cor.test(samp[, ..var1][[1]],
                                 samp[, ..var2][[1]],
                                 method="spearman")$p.value
      }
    }
    dsep_c_1Mb[rep, c] <- combine.test(pvals_1Mb, weights, "fisher", na.rm=T)
  }
}
close(pb)

fwrite(dsep_c_1Mb, "real_data_maps/dsep_1Mb_pisim_m1.csv.gz")
```
...
fwrite(dsep_c_1Mb, "real_data_maps/dsep_1Mb_pisim_m2.csv.gz")
```
...
fwrite(dsep_c_1Mb, "real_data_maps/dsep_1Mb_pisim_m3.csv.gz")
```
...
fwrite(dsep_c_1Mb, "real_data_maps/dsep_1Mb_pisim_m4.csv.gz")
```
Path models with human maps

```{r DAGs-lavaan-human-data, include=F, message=F, warning=F}

DAG_nonmutrec_pitot <- "
pi_sim_tot ~ start(0.5)*c1*B
pi_sim_tot ~ start(0.5)*c2*avg_mut
B ~ start(-0.25)*c3*avg_mut
B ~ start(-0.5)*c6*del_sites
B ~ start(0.2)*c4*avg_rec
avg_mut ~~ 0*avg_rec
...
Testing model fitting at the 1 Mb scale

Not filtering adjacent windows:

```{r SEM-human-maps-F1w, include=F, message=F, warning=F}

human_maps_1Mb$coverage <- human_maps_1Mb$num_sites / 1e+6 
human_maps_1Mb$bin <- human_maps_1Mb$chromStart %/% 1e+6 # to reduce autocorrelation
dat_1Mb <- human_maps_1Mb %>% 
           group_by(chr) %>%
           filter(., del_sites > 0, coverage > 0.75, chr!=19) %>% # chr 19 too few data points
           na.exclude() %>% 
           distinct(bin, .keep_all=T)

std_1Mb <- as.data.frame(apply(dplyr::select(dat_1Mb,
  c(B, avg_rec, del_sites, avg_mut, avg_pi, pi_sim_tot, pi_sim_neu, pi_sim_del)),
  2, log))
std_1Mb$chr <- dat_1Mb$chr

fwrite(dat_1Mb, "SEM/Filter_1w/dat_1Mb.csv.gz") # stored used table
...
fwrite(parameterestimates(m1gls, ci=F), "SEM/Filter_1w/m1gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m1gls))), "SEM/Filter_1w/m1gls_fit.csv")
fwrite(as.data.frame(inspect(m1gls, "rsquare")), "SEM/Filter_1w/m1gls_r2.csv") # one per chr
...
fwrite(parameterEstimates(m1boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_1w/m1boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m1boot))), "SEM/Filter_1w/m1boot_fit.csv")
fwrite(as.data.frame(inspect(m1boot, "rsquare")), "SEM/Filter_1w/m1boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m2gls, ci=F), "SEM/Filter_1w/m2gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m2gls))), "SEM/Filter_1w/m2gls_fit.csv")
fwrite(as.data.frame(inspect(m2gls, "rsquare")), "SEM/Filter_1w/m2gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m2boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_1w/m2boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m2boot))), "SEM/Filter_1w/m2boot_fit.csv")
fwrite(as.data.frame(inspect(m2boot, "rsquare")), "SEM/Filter_1w/m2boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m3gls, ci=F), "SEM/Filter_1w/m3gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m3gls))), "SEM/Filter_1w/m3gls_fit.csv")
fwrite(as.data.frame(inspect(m3gls, "rsquare")), "SEM/Filter_1w/m3gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m3boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_1w/m3boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m3boot))), "SEM/Filter_1w/m3boot_fit.csv")
fwrite(as.data.frame(inspect(m3boot, "rsquare")), "SEM/Filter_1w/m3boot_r2.csv") # one per chr

# incorporating del sites
model_4 <- "
avg_pi ~ start(0.75)*c1*B
avg_pi ~ start(0.75)*c2*avg_mut
B ~ start(-0.25)*c3*avg_mut
B ~ start(-0.1)*c4*del_sites
avg_mut ~~ 0*del_sites
avg_mut ~~ 0*B
"
...
fwrite(parameterestimates(m4gls, ci=F), "SEM/Filter_1w/m4gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m4gls))), "SEM/Filter_1w/m4gls_fit.csv")
fwrite(as.data.frame(inspect(m4gls, "rsquare")), "SEM/Filter_1w/m4gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m4boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_1w/m4boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m4boot))), "SEM/Filter_1w/m4boot_fit.csv")
fwrite(as.data.frame(inspect(m4boot, "rsquare")), "SEM/Filter_1w/m4boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m5gls, ci=F), "SEM/Filter_1w/m5gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m5gls))), "SEM/Filter_1w/m5gls_fit.csv")
fwrite(as.data.frame(inspect(m5gls, "rsquare")), "SEM/Filter_1w/m5gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m5boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_1w/m5boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m5boot))), "SEM/Filter_1w/m5boot_fit.csv")
fwrite(as.data.frame(inspect(m5boot, "rsquare")), "SEM/Filter_1w/m5boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m6gls, ci=F), "SEM/Filter_1w/m6gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m6gls))), "SEM/Filter_1w/m6gls_fit.csv")
fwrite(as.data.frame(inspect(m6gls, "rsquare")), "SEM/Filter_1w/m6gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m6boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_1w/m6boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m6boot))), "SEM/Filter_1w/m6boot_fit.csv")
fwrite(as.data.frame(inspect(m6boot, "rsquare")), "SEM/Filter_1w/m6boot_r2.csv") # one per chr
```

Filtering every other window:

```{r SEM-human-maps-F1w, include=F, message=F, warning=F}

human_maps_1Mb$coverage <- human_maps_1Mb$num_sites / 1e+6 
human_maps_1Mb$bin <- human_maps_1Mb$chromStart %/% 2e+6 # to reduce autocorrelation
dat_1Mb <- human_maps_1Mb %>% 
           group_by(chr) %>%
           filter(., del_sites > 0, coverage > 0.75, chr!=19) %>% # chr 19 too few data points
           na.exclude() %>% 
...
fwrite(dat_1Mb, "SEM/Filter_2w/dat_1Mb.csv.gz") # stored used table
...
fwrite(parameterestimates(m1gls, ci=F), "SEM/Filter_2w/m1gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m1gls))), "SEM/Filter_2w/m1gls_fit.csv")
fwrite(as.data.frame(inspect(m1gls, "rsquare")), "SEM/Filter_2w/m1gls_r2.csv") # one per chr
...
fwrite(parameterEstimates(m1boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_2w/m1boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m1boot))), "SEM/Filter_2w/m1boot_fit.csv")
fwrite(as.data.frame(inspect(m1boot, "rsquare")), "SEM/Filter_2w/m1boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m2gls, ci=F), "SEM/Filter_2w/m2gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m2gls))), "SEM/Filter_2w/m2gls_fit.csv")
fwrite(as.data.frame(inspect(m2gls, "rsquare")), "SEM/Filter_2w/m2gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m2boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_2w/m2boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m2boot))), "SEM/Filter_2w/m2boot_fit.csv")
fwrite(as.data.frame(inspect(m2boot, "rsquare")), "SEM/Filter_2w/m2boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m3gls, ci=F), "SEM/Filter_2w/m3gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m3gls))), "SEM/Filter_2w/m3gls_fit.csv")
fwrite(as.data.frame(inspect(m3gls, "rsquare")), "SEM/Filter_2w/m3gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m3boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_2w/m3boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m3boot))), "SEM/Filter_2w/m3boot_fit.csv")
fwrite(as.data.frame(inspect(m3boot, "rsquare")), "SEM/Filter_2w/m3boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m4gls, ci=F), "SEM/Filter_2w/m4gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m4gls))), "SEM/Filter_2w/m4gls_fit.csv")
fwrite(as.data.frame(inspect(m4gls, "rsquare")), "SEM/Filter_2w/m4gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m4boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_2w/m4boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m4boot))), "SEM/Filter_2w/m4boot_fit.csv")
fwrite(as.data.frame(inspect(m4boot, "rsquare")), "SEM/Filter_2w/m4boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m5gls, ci=F), "SEM/Filter_2w/m5gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m5gls))), "SEM/Filter_2w/m5gls_fit.csv")
fwrite(as.data.frame(inspect(m5gls, "rsquare")), "SEM/Filter_2w/m5gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m5boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_2w/m5boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m5boot))), "SEM/Filter_2w/m5boot_fit.csv")
fwrite(as.data.frame(inspect(m5boot, "rsquare")), "SEM/Filter_2w/m5boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m6gls, ci=F), "SEM/Filter_2w/m6gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m6gls))), "SEM/Filter_2w/m6gls_fit.csv")
fwrite(as.data.frame(inspect(m6gls, "rsquare")), "SEM/Filter_2w/m6gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m6boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_2w/m6boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m6boot))), "SEM/Filter_2w/m6boot_fit.csv")
fwrite(as.data.frame(inspect(m6boot, "rsquare")), "SEM/Filter_2w/m6boot_r2.csv") # one per chr
```

Filtering 1 every 3 windws:

```{r SEM-human-maps-F1w, include=F, message=F, warning=F}

human_maps_1Mb$coverage <- human_maps_1Mb$num_sites / 1e+6 
human_maps_1Mb$bin <- human_maps_1Mb$chromStart %/% 3e+6 # to reduce autocorrelation
dat_1Mb <- human_maps_1Mb %>% 
           group_by(chr) %>%
           filter(., del_sites > 0, coverage > 0.75, chr!=19) %>% # chr 19 too few data points
           na.exclude() %>% 
...
fwrite(dat_1Mb, "SEM/Filter_3w/dat_1Mb.csv.gz") # stored used table
...
fwrite(parameterestimates(m1gls, ci=F), "SEM/Filter_3w/m1gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m1gls))), "SEM/Filter_3w/m1gls_fit.csv")
fwrite(as.data.frame(inspect(m1gls, "rsquare")), "SEM/Filter_3w/m1gls_r2.csv") # one per chr
...
fwrite(parameterEstimates(m1boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_3w/m1boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m1boot))), "SEM/Filter_3w/m1boot_fit.csv")
fwrite(as.data.frame(inspect(m1boot, "rsquare")), "SEM/Filter_3w/m1boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m2gls, ci=F), "SEM/Filter_3w/m2gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m2gls))), "SEM/Filter_3w/m2gls_fit.csv")
fwrite(as.data.frame(inspect(m2gls, "rsquare")), "SEM/Filter_3w/m2gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m2boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_3w/m2boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m2boot))), "SEM/Filter_3w/m2boot_fit.csv")
fwrite(as.data.frame(inspect(m2boot, "rsquare")), "SEM/Filter_3w/m2boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m3gls, ci=F), "SEM/Filter_3w/m3gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m3gls))), "SEM/Filter_3w/m3gls_fit.csv")
fwrite(as.data.frame(inspect(m3gls, "rsquare")), "SEM/Filter_3w/m3gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m3boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_3w/m3boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m3boot))), "SEM/Filter_3w/m3boot_fit.csv")
fwrite(as.data.frame(inspect(m3boot, "rsquare")), "SEM/Filter_3w/m3boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m4gls, ci=F), "SEM/Filter_3w/m4gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m4gls))), "SEM/Filter_3w/m4gls_fit.csv")
fwrite(as.data.frame(inspect(m4gls, "rsquare")), "SEM/Filter_3w/m4gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m4boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_3w/m4boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m4boot))), "SEM/Filter_3w/m4boot_fit.csv")
fwrite(as.data.frame(inspect(m4boot, "rsquare")), "SEM/Filter_3w/m4boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m5gls, ci=F), "SEM/Filter_3w/m5gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m5gls))), "SEM/Filter_3w/m5gls_fit.csv")
fwrite(as.data.frame(inspect(m5gls, "rsquare")), "SEM/Filter_3w/m5gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m5boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_3w/m5boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m5boot))), "SEM/Filter_3w/m5boot_fit.csv")
fwrite(as.data.frame(inspect(m5boot, "rsquare")), "SEM/Filter_3w/m5boot_r2.csv") # one per chr
...
fwrite(parameterestimates(m6gls, ci=F), "SEM/Filter_3w/m6gls_est.csv")
fwrite(t(as.data.frame(fitMeasures(m6gls))), "SEM/Filter_3w/m6gls_fit.csv")
fwrite(as.data.frame(inspect(m6gls, "rsquare")), "SEM/Filter_3w/m6gls_r2.csv") # one per chr
...
fwrite(parameterestimates(m6boot,
                          boot.ci.type="norm",
                          ci=T,
                          standardized=T), "SEM/Filter_3w/m6boot_est.csv")
fwrite(t(as.data.frame(fitMeasures(m6boot))), "SEM/Filter_3w/m6boot_fit.csv")
fwrite(as.data.frame(inspect(m6boot, "rsquare")), "SEM/Filter_3w/m6boot_r2.csv") # one per chr
```
...
# NOTE testing
names(human_filtered_10kb)[which(names(human_filtered_10kb)=="avg_pi")] <- "sim_pi"
names(human_filtered_100kb)[which(names(human_filtered_100kb)=="avg_pi")] <- "sim_pi"
names(human_filtered_1Mb)[which(names(human_filtered_1Mb)=="avg_pi")] <- "sim_pi"
...
for(c in 1:22) {
  ...
  for(i in 1:length(basis_set)) {
    ...
    stopifnot(dSep(D3g, var1, var2, cond))
