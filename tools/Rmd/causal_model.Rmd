...
for(m in unique(human_maps_10kb$constrained_model)) { 
  ...
  fwrite(rbind.data.frame(names(unlist(inspect(m0gls_free, "r2"))),
                          as.numeric(unlist(inspect(m0gls_free, "r2")))), 
         paste("real_data_maps/lavaan_out/YRI_DAG0_r2_10kb_genomewide_", 
               "latents_", m, "_freechrom.csv", sep=""),
         col.names=F)
  
  fwrite(parameterestimates(m0gls_free, ci=T), 
         paste("real_data_maps/lavaan_out/YRI_DAG0_params_10kb_genomewide_", 
               "latents_", m, "_freechrom.csv", sep=""))
  
  fwrite(rbind.data.frame(names(fitMeasures(m0gls_free)),
                          as.numeric(fitMeasures(m0gls_free))), 
         paste("real_data_maps/lavaan_out/YRI_DAG0_fitmeasures_10kb_genomewide_", 
               "latents_", m, "_freechrom.csv", sep=""),
         col.names=F)
  
  fwrite(lavTestLRT(m0gls, m0gls_free),
         paste("real_data_maps/lavaan_out/LRT_DAG0_gw-equal-freechrom_10kb_", 
               "latents_", m, ".csv", sep=""))
  ...
  fwrite(rbind.data.frame(names(unlist(inspect(m1gls_free, "r2"))),
                          as.numeric(unlist(inspect(m1gls_free, "r2")))), 
         paste("real_data_maps/lavaan_out/YRI_DAG1_r2_10kb_genomewide_", 
               "latents_", m, "_freechrom.csv", sep=""),
         col.names=F)
  
  fwrite(parameterestimates(m1gls_free, ci=T), 
         paste("real_data_maps/lavaan_out/YRI_DAG1_params_10kb_genomewide_", 
               "latents_", m, "_freechrom.csv", sep=""))
  
  fwrite(rbind.data.frame(names(fitMeasures(m1gls_free)),
                          as.numeric(fitMeasures(m1gls_free))), 
         paste("real_data_maps/lavaan_out/YRI_DAG1_fitmeasures_10kb_genomewide_", 
               "latents_", m, "_freechrom.csv", sep=""),
         col.names=F)
  
  fwrite(lavTestLRT(m1gls, m1gls_free),
         paste("real_data_maps/lavaan_out/LRT_DAG1_gw-equal-freechrom_10kb_", 
               "latents_", m, ".csv", sep=""))
...
for(m in unique(human_maps_100kb$constrained_model)) { 
  ...
  fwrite(lavTestLRT(m0gls, m0gls_free),
         paste("real_data_maps/lavaan_out/LRT_DAG0_gw-equal-freechrom_100kb_", 
               "latents_", m, ".csv", sep=""))
  ...
  fwrite(lavTestLRT(m1gls, m1gls_free),
         paste("real_data_maps/lavaan_out/LRT_DAG1_gw-equal-freechrom_100kb_", 
               "latents_", m, ".csv", sep=""))
...
for(m in unique(human_maps_1Mb$constrained_model)) { 
  ...
  tbl_1Mb <- filter(tbl_1Mb, coverage > 0.75)
  ...
  fwrite(lavTestLRT(m0gls, m0gls_free),
         paste("real_data_maps/lavaan_out/LRT_DAG0_gw-equal-freechrom_1Mb_", 
               "latents_", m, ".csv", sep=""))
  ...
  fwrite(lavTestLRT(m1gls, m1gls_free),
         paste("real_data_maps/lavaan_out/LRT_DAG1_gw-equal-freechrom_1Mb_", 
               "latents_", m, ".csv", sep=""))
...
for(dag in 0:3) {
  for(m in unique(human_maps_10kb$constrained_model)) { 
    tmp <- fread(paste("real_data_maps/lavaan_out/YRI_DAG2_fitmeasures_10kb_genomewide", 
           "_latents_", m, "_BOOT.csv", sep=""))
...
for(dag in 0:3) {
  for(m in unique(human_maps_100kb$constrained_model)) { 
    tmp <- fread(paste("real_data_maps/lavaan_out/YRI_DAG2_fitmeasures_100kb_genomewide", 
           "_latents_", m, "_BOOT.csv", sep=""))
...
for(dag in 0:3) {
  for(m in unique(human_maps_1Mb$constrained_model)) { 
    tmp <- fread(paste("real_data_maps/lavaan_out/YRI_DAG2_fitmeasures_1Mb_genomewide", 
           "_latents_", m, "_BOOT.csv", sep=""))
...
for(m in unique(human_maps_10kb$constrained_model)) { 
  for(d in 0:3) {
    ...
    LRT_gw_freechrom <- rbind.data.frame(LRT_gw_freechrom, df)
  }
}
LRT_gw_freechrom$scale <- 1e+4
...
gw_LRT_latent <- rbind.data.frame(gw_LRT_boot, gw_LRT_gls)
...
p <- ggplot(data=gw_LRT_latent, 
      ...
      theme(axis.title=element_text(size=16), 
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/gw_LRT_latent.png", p, 
