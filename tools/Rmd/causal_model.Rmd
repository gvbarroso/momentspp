...
x <- m_dsep_human_100kb %>% group_by(DAG, pi, chr) %>% 
...
save_plot("pairwise_d-sep_human_DAGs_pisim_100kb.png", p2, 
...
p3 <- ggpubr::ggboxplot(data=piobs_tbl,
      ...
      theme(plot.title=element_text(size=26),
            ...
            axis.text=element_text(size=16),
            strip.text.x=element_text(size=14))
save_plot("pairwise_d-sep_human_DAGs_piobs_100kb.png", p3, 
          base_height=20, base_width=30)
...
B ~ start(0.25)*c5*avg_rec
avg_mut ~ start(0.25)*c6*avg_rec
prop_del_sites ~ avg_mut
prop_del_sites ~ avg_rec
avg_mut ~~ B
"
