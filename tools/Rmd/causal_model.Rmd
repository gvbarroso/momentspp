...
p <- ggplot(data=filter(chr_anova, demo=="equilibrium"), # eq. =~ 4-epoch
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="ANOVA test of nested DAGs 2 & 3 (per chr models)",
           x="Chromosome", y="-log10(p-value)") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
...
p <- ggplot(data=gw_r2_pi, 
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Variance Explained in diversity (genome-wide model)",
...
q <- ggplot(data=gw_r2_B, 
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Variance Explained in B (genome-wide model)",
           x="Chromosome", y="Variance Explained") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/gw_r2_B.png", q, 
          base_height=10, base_width=16)
...
r <- ggplot(data=gw_r2_mut, 
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Variance Explained in mut. (genome-wide model)",
           x="Chromosome", y="Variance Explained") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/gw_r2_mut.png", q, 
          base_height=10, base_width=16)
...
p <- ggplot(data=chr_r2, 
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Variance Explained in pi (chr-specific models)",
           x="Chromosome", y="Variance Explained") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/chr_r2_pi.png", p, 
          base_height=10, base_width=16)
...
q <- ggplot(data=chr_r2, 
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Variance Explained in B (chr-specific models)",
           x="Chromosome", y="Variance Explained") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/chr_r2_B.png", p, 
          base_height=10, base_width=16)

r <- ggplot(data=chr_r2, 
             aes(x=chrom, 
                 y=avg_mut, 
                 color=mut_map,
                 shape=as.factor(DAG))) +
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"), 
                         name="Mut. Map") +
      labs(title="Variance Explained in mut. (chr-specific models)",
           x="Chromosome", y="Variance Explained") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/chr_r2_mut.png", p, 
          base_height=10, base_width=16)

# DAGs 2-3 (mu as endogeneous)
## 10 kb
gw_r2_10kb <- data.frame()
for(dag in 2:3) { 
  for(u in unique(human_maps_100kb$mut_map)) {
...
p <- ggplot(data=chr_r2, 
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Variance Explained in pi (chr-specific models, DAGs 2-3)",
           x="Chromosome", y="Variance Explained") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/chr_r2_pi_DAGs2-3.png", p, 
          base_height=10, base_width=16)
...
q <- ggplot(data=chr_r2, 
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Variance Explained in B (chr-specific models, DAGs 2-3)",
           x="Chromosome", y="Variance Explained") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/chr_r2_B_DAGs2-3.png", p, 
          base_height=10, base_width=16)
...
r <- ggplot(data=chr_r2, 
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"), 
                         name="Mut. Map") +
      labs(title="Variance Explained in mut. (chr-specific models, DAGs 2-3)",
           x="Chromosome", y="Variance Explained") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
            ...
            legend.title=element_text(size=16),
            legend.position="bottom")
save_plot("real_data_maps/lavaan_out/chr_r2_mut_DAGs2-3.png", p, 
          base_height=10, base_width=16)
```
...
p <- ggplot(data=filter(gw_params, lhs=="avg_pi"), 
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Std. Path Coefficients (genome-wide model)",
           x="Variable", y="Std. Path Coefficient") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
            legend.text=element_text(size=16),
...
p <- ggplot(data=filter(chr_params, lhs=="avg_pi", 
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Path Coefficients to Pi DAG 2",
           x="Chromosome", y="PC to Pi") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
            legend.text=element_text(size=16),
...
q <- ggplot(data=filter(chr_params, lhs=="avg_pi", 
                        DAG==3), 
             aes(x=chrom, 
                 y=est, 
                 color=mut_map,
      ...
      scale_color_manual(values=c("purple3", "seagreen4", "brown1"),
                         name="Mut. Map") +
      labs(title="Path Coefficients to Pi DAG 3",
           x="Chromosome", y="PC to Pi") +
      theme(axis.title=element_text(size=16), 
            axis.text=element_text(size=12), 
            axis.text.x=element_text(size=12),
...
# ratios of PCs
chr_wide <- chr_params %>% filter(., pvalue < 5e-2) %>%
         dplyr::select(., -c(op, label, se, z, pvalue, ci.lower, ci.upper)) %>%
...
for(c in 1:22) {
  r <- ggplot(data=filter(chr_wide, chrom==c), 
               aes(x=scale, 
                   y=ratio_B_u, 
                   color=mut_map,
                   shape=as.factor(DAG))) +
        geom_point(size=2.5) + 
        facet_grid(~constrained_model, labeller=label_both) + theme_bw() + 
        scale_y_continuous(breaks=pretty_breaks()) +
        ...
        scale_color_manual(values=c("purple3", "seagreen4", "brown1"), 
                           name="Mut. Map") +
        labs(title="Ratio of Path Coefficients to Pi",
             x="Scale", y="PC(B) / PC(Mu)") +
        theme(axis.title=element_text(size=16), 
              axis.text=element_text(size=12), 
              axis.text.x=element_text(size=12),
              legend.text=element_text(size=16),
              legend.title=element_text(size=16),
              legend.position="bottom")
  save_plot(paste("real_data_maps/lavaan_out/sem_params_pi_chr", c, 
                  ".png", sep=""),
...
mut_maps_10kb$mean_mut_carlson[which(mut_maps_10kb$sum_sites_carlson < 5.5e+3)] <- NA
...
mut_maps_1Mb$mean_mut_roulette[which(mut_maps_1Mb$sum_sites_roulette < 7.5e+5)] <- NA
mut_maps_1Mb$mean_mut_masked_roulette[which(mut_maps_1Mb$sum_sites_masked_roulette < 7.5e+5)] <- NA
mut_maps_1Mb$mean_mut_carlson[which(mut_maps_1Mb$sum_sites_carlson < 7.5e+5)] <- NA
mut_maps_1Mb$mean_mut_masked_carlson[which(mut_maps_1Mb$sum_sites_masked_carlson < 7.5e+5)] <- NA
mut_maps_1Mb$mean_mut_gnomad[which(mut_maps_1Mb$sum_sites_gnomad < 7.5e+5)] <- NA
mut_maps_1Mb$mean_mut_masked_gnomad[which(mut_maps_1Mb$sum_sites_masked_gnomad < 7.5e+5)] <- NA

# testing measurement model on chr1, 1 Mb scale
names(mut_maps_1Mb)[1] <- "chrom"
df_1Mb <- left_join(mut_maps_1Mb, human_maps_1Mb, by=c("chrom",
                                                       "chromStart",
                                                       "chromEnd"))

# ismc chr 1, from the book chapter Barroso & Dutheil 2025/6
ismc_chr1 <- fread("~/Data/iSMC/iSMC_Mbuti/Mbuti_chr1.theta.1Mb.bedgraph")
ismc_chr1$chrom <- 1
...
p1 <- ggpairs(dplyr::select(mut_chr1_1Mb, c(mean_mut_masked_carlson,
                                            mean_mut_masked_roulette,
                                            mean_mut_masked_gnomad,
                                            #ismc_1,
                                            #ismc_2,
...
mut_measurement_3 <- "
mu=~mean_mut_masked_roulette + mean_mut_masked_carlson + mean_mut_masked_gnomad + ismc_mean
mean_mut_masked_roulette ~~ ismc_mean
"
