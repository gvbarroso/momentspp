...
Ns <- paste(1e+4, 1e+3, sep=";") # from present to past
Ts <- paste(0, 20000, sep=";") # from present (0) to past, in generations
...
right <- filter(hets, V1=="Hr_0_0")
right <- right[!duplicated(right$V4)]
pi0[1,] <- t(dplyr::select(filter(moms, V1=="Hr_0_0"), V3))
