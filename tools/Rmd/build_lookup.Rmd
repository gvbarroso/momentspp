...
knitr::opts_knit$set(root.dir="~/Data/momentspp/paper_1/test_s/")
```
...
Ns <- paste(15000, 40000, 20000, 30000, sep=";") # from present to past
Ts <- paste(0, 4000, 24000, 100000, sep=";") # from present (0) to past, in generations
