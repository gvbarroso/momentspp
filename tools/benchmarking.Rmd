...
```{bash create-dirs, engine.opts='-i', include=F, eval=T, results=F, message=F, warning=F}
...
N <- c(2500, 10000)
u <- c(1e-8, 1e-7)
r <- c(0, 1e-7, 1e-6, 1e-5, 1e-4)
s <- c(-1e-3, -5e-4, -2e-4, -1e-4, -5e-5)
...
for(i in 1:n_models) {
  ...
  comb <- plot_grid(p1, p2, p3, p4, ncol=1)
  save_plot(paste("selection/single-pop/mut_rate_var_left/model_", i, "/landscapes.png", sep=""), comb, base_height=10, base_width=12)
  ...
  for(j in unique(molten_windows$scales_mu)) {
    for(k in unique(molten_windows$scales_rec)) {
      ...
      p <- p + theme(axis.title=element_text(size=16),
                     ...
                     axis.text.x=element_text(angle=90, size=12, vjust=0.5, hjust=1.0),
                     legend.position="bottom")
      save_plot(paste("selection/single-pop/mut_rate_var_left/Hr_landscapes_", c, ".png", sep=""), p, base_height=10, base_width=15)
...
p1 <- p1 + theme(axis.title=element_text(size=16),
                 ...
                 axis.text.x=element_text(angle=90, size=12, vjust=0.5, hjust=1.0),
                 legend.position="bottom")
save_plot(paste("selection/single-pop/mut_rate_var_left/Hr_landscapes_", c + 1, ".png", sep=""), p1, base_height=10, base_width=15)
...
p2 <- p2 + theme(axis.title=element_text(size=16),
                 ...
                 axis.text.x=element_text(angle=90, size=12, vjust=0.5, hjust=1.0),
                 legend.position="bottom")
save_plot(paste("selection/single-pop/mut_rate_var_left/Hr_landscapes_", c + 2, ".png", sep=""), p2, base_height=10, base_width=15)
...
p3 <- p3 + theme(axis.title=element_text(size=16),
                 ...
                 axis.text.x=element_text(angle=90, size=12, vjust=0.5, hjust=1.0),
                 legend.position="bottom")
save_plot(paste("selection/single-pop/mut_rate_var_left/Hr_landscapes_", c + 3, ".png", sep=""), p3, base_height=10, base_width=15)
...
p5 <- p5 + theme(axis.title=element_text(size=16), 
                 ...
                 axis.text.x=element_text(angle=90, size=12, vjust=0.5, hjust=1.0),
                 legend.text=element_text(size=16), legend.position="bottom")
save_plot("selection/single-pop/mut_rate_var_left/R2_plot_1.png", p5, base_height=10, base_width=15)
...
p6 <- p6 + theme(axis.title=element_text(size=16), 
                 ...
                 axis.text.x=element_text(angle=90, size=12, vjust=0.5, hjust=1.0),
                 legend.text=element_text(size=16), legend.position="bottom")
save_plot("selection/single-pop/mut_rate_var_left/R2_plot_2.png", p6, base_height=10, base_width=15)
...
p7 <- p7 + theme(axis.title=element_text(size=16), 
                 ...
                 axis.text.x=element_text(angle=90, size=12, vjust=0.5, hjust=1.0),
                 legend.text=element_text(size=16), legend.position="bottom")
save_plot("selection/single-pop/mut_rate_var_left/R2_plot_3.png", p7, base_height=10, base_width=15)
```
