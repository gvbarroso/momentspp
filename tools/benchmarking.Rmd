...
save_plot("selection/single-pop/simple_bgs/bgs_single_neutral_scaling_1.pdf", bgs_plot_1, base_height=12, base_width=16)
...
for(i in unique(tbl2$l)) {
  ...
  if(c==1) {
    p <- p + labs(title="Hr / scaled_hr, L = 10", x="r", y="Ratio")
    p <- p + theme(axis.title=element_text(size=16), 
                   axis.text=element_text(size=12), 
                   strip.text.x=element_text(size=16), 
                   axis.title.x=element_blank(),
...
bgs_plot_2 <- plot_grid(plotlist=plot_list, ncol=1, rel_heights=c(1, 1.1))
save_plot("selection/single-pop/simple_bgs/bgs_single_neutral_scaling_2.pdf", bgs_plot_2, base_height=12, base_width=16)
...
for(i in unique(df$N)) {
  ...
  save_plot(paste("selection/single-pop/simple_bgs/bgs_single_neutral_mpp_A_N_", i, ".pdf", sep=""), bgs_plot_3, base_height=12, base_width=16)
}
...
save_plot("selection/single-pop/simple_bgs/bgs_single_neutral_mpp_B.pdf", bgs_plot_2, base_height=12, base_width=16)
...
for(i in unique(df$N)) {
  ...
  save_plot(paste("selection/single-pop/simple_bgs/bgs_single_neutral_hk95_N_", i, ".pdf", sep=""), bgs_plot_4, base_height=12, base_width=24)
}
...
for(i in unique(df$N)) {
  ...
  bgs_plot_5 <- plot_grid(plotlist=plot_list, ncol=1, rel_heights=c(1.15, 1, 1, 1, 1.75))
  save_plot(paste("selection/single-pop/simple_bgs/bgs_mpp_hk95_N_", i, ".pdf", sep=""), bgs_plot_5, base_height=12, base_width=24)
}
