...
df_sym_N[df_sym_N$r==0,]$r <- 1e-12

d1d2 <- subset(df_sym_N, stats %in% c("DD_1_2", "pi2_1_2_1_2")) 
ratio <- d1d2[d1d2$stats=="DD_1_2",]$expectation / d1d2[d1d2$stats=="pi2_1_2_1_2",]$expectation
