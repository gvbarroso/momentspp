...
write.csv(params, "selection/single-pop/simple_bgs/params.csv", quote=F, row.names=F)
...
for(i in 1:n_models) {
  ...
  for(j in 1:w) { # left locus
      ...
      sink(paste("selection/single-pop/simple_bgs/", name, ".yaml", sep=""))
...
params <- read.table("selection/single-pop/simple_bgs/params.csv", sep=",", header=T)
...
for(i in 1:n_models) {
  ...
  for(j in 1:w) { # left locus
    ...
    expectations <- read.table(paste("selection/single-pop/simple_bgs/", name, sep=""))
