...
for i in range(1, n_models):
  with open(f"neutrality/no_migration/moments_LD_model_{i}.csv", "w+") as fout:
      f = f"neutrality/no_migration/model_{i}.yaml"
      pops = ["A", "B"]
      u = params["u"][i]
      r = params["r"][i]
...
```{python run-momentsTwoLocus, include=T, eval=T, results=T}
...
F = moments.TwoLocus.Demographics.equilibrium(n_samples, rho=rho, theta=theta, sel_params=gammas)
