...
core_stats <- c("DD_1_1", "DD_1_2", "DD_2_2",
                "Dr_1_1_(1-2p1)^1", "Dr_1_1_(1-2p2)^1", "Dr_1_2_(1-2p2)^1", "Dr_2_1_(1-2p1)^1", "Dr_2_1_(1-2p2)^1", "Dr_2_2_(1-2p2)^1",
                "pi2_1_1_1_1", "pi2_1_1_1_2", "pi2_1_1_2_2", "pi2_1_2_1_2", "pi2_1_2_2_2", "pi2_2_2_2_2",
                "Hl_1_1", "Hl_1_2", "Hl_2_2")
...
tbl$scenario <- c(rep(1, length(core_stats)), rep(2, length(core_stats)), rep(3, length(core_stats)), rep(4, length(core_stats)))
...
p1 <- p1 + scale_shape_manual(values=(0:3))
